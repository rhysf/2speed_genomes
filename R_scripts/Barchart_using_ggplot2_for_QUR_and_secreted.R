...
go_term	go_desc	go_term_and_desc	Enriched_in_this_many_genomes	pc
GO:0005886	plasma membrane	GO:0005886 (plasma membrane)	670	50
GO:0055085	transmembrane transport	GO:0055085 (transmembrane transport)	472	30
GO:0022857	transmembrane transporter activity	GO:0022857 (transmembrane transporter activity)	346	20
...
tmpPlot <- ggplot(
       data,
       aes(
           x = reorder(go_term_and_desc, Enriched_in_this_many_genomes),
           y = pc
       )
) +
...
Plot <- tmpPlot + theme(axis.text.x=element_text(angle = 0, hjust = 0.5),
